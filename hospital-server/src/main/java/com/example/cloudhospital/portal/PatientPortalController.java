...
public class PatientPortalController {
    ...
    public PatientPortalController(PatientPortalMapper patientPortalMapper, RegistrationService registrations, PrescriptionService prescriptions) {
    ...
    public ApiResponse<Void> cancelRegistration(@PathVariable Long id, @RequestBody(required = false) RegistrationController.CancelRequest request, HttpServletRequest req) {
    ...
    public ApiResponse<List<com.example.cloudhospital.prescription.PrescriptionItem>> prescriptionItems(@PathVariable Long id, HttpServletRequest req) {
        Prescription prescription = prescriptions.get(id);
        if (!Objects.equals(prescription.patientId, session(req).patientId()))
