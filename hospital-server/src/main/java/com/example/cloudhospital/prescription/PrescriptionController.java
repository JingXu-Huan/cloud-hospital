...
public class PrescriptionController {
    ...
    @PostMapping("/prescriptions/{id}/manual-pay") public ApiResponse<Void> manuallyPayForUnregisteredPatient(@PathVariable Long id) { service.manuallyPayForUnregisteredPatient(id); return ApiResponse.ok(); }
    ...
    public record PrescriptionView(Long id,String prescriptionNo,Long registrationId,Long patientId,String patientName,Long doctorId,String doctorName,PrescriptionStatus status,BigDecimal totalAmount,String paymentMethod,LocalDateTime prescribedAt,LocalDateTime paidAt,LocalDateTime dispensedAt,LocalDateTime pickedUpAt,String remark,boolean patientRegistered) {}
