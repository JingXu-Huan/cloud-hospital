...
public class PrescriptionService {
    ...
    @Transactional public void manuallyPayForUnregisteredPatient(Long id) {
        Prescription prescription=get(id);
        if(hasPatientAccount(prescription.patientId)) throw new BizException(43005,"该患者已注册患者端，请由患者本人完成支付");
        pay(id,"CASH");
    }
