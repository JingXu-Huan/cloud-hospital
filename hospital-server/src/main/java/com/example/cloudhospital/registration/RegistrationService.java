...
public class RegistrationService {
    ...
    @Transactional public Registration create(Long patientId, Long doctorId, LocalDate date) {
        ...
        if (registrations.existsByPatientIdAndDoctorIdAndVisitDateAndStatusIn(patientId,doctorId,date,List.of(RegistrationStatus.WAITING,RegistrationStatus.IN_PROGRESS))) throw new BizException(41002,"同日同一医生已有未取消挂号");
